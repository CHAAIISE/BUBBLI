...
export const CONTRACT_ABI = [
  ...
  },
  {
    type: "function",
    name: "changeMood",
    inputs: [{ name: "newMood", type: "uint8", internalType: "enum MoodNFT.Mood" }],
    outputs: [],
    stateMutability: "nonpayable",
  },
  {
  ...
  },
  {
    ...
    name: "getMood",
    inputs: [{ name: "tokenId", type: "uint256", internalType: "uint256" }],
    outputs: [{ name: "", type: "uint8", internalType: "enum MoodNFT.Mood" }],
    stateMutability: "view",
  },
  {
    type: "function",
  ...
  },
  {
    type: "function",
    name: "mintNFT",
    inputs: [{ name: "mood", type: "uint8", internalType: "enum MoodNFT.Mood" }],
    outputs: [{ name: "", type: "uint256", internalType: "uint256" }],
    stateMutability: "nonpayable",
  },
  {
  ...
  },
  {
    ...
    inputs: [
      { name: "tokenId", type: "uint256", indexed: true, internalType: "uint256" },
      { name: "oldMood", type: "uint8", indexed: false, internalType: "enum MoodNFT.Mood" },
      { name: "newMood", type: "uint8", indexed: false, internalType: "enum MoodNFT.Mood" },
    ],
    anonymous: false,
  },
  {
